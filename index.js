...
function setup() {
  ...
  select.option ('FLASH')
  select.option ('GLITCH')
  select.position (660,755)
  ...
  cajatexto.addClass("minimalTextarea")

  picker = createColorPicker (255)
  picker.position (width/2 - 50,835)
  picker.addClass("customColorPicker")
...
// este lo puse al final, porque sino se me pisa con otras cosas, y solo necesito un rectangul que vaya por encima de todo. 

 if (eleccion == 'FLASH') {
if (frameCount % 3 < 1) { //encontré esta función, que lo que hace es se dibuje uno de cada 3 frames, o 20 veces por segundo. Si voy cambiando los parametros puedo hacer que el parpaadeo dure mas, o menos, y que la velocidad cambie. Por ejemplo si yo pongo frameCount % 60 < 30) parpadea una ves por segundo, estando a 60fps. 
    fill(c)
